...
import DashboardLayout from "../components/Layout/DashboardLayout"; // New layout component
import DashboardContent from "../components/DashboardContent"; // New content component
import LoadingSpinner from "../components/LoadingSpinner"; // New spinner component
import ErrorMessage from "../components/ErrorMessage"; // New error component
...
const DashboardPage = () => {
    ...
    return (
        <DashboardLayout title="Dashboard - mAIple Conference Portal" description="Your personal mAIple AI Conference dashboard.">
