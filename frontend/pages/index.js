  ...
  useEffect(() => {
    ...
    if (carousel) {
      ...
      const scrollCarousel = () => {
        ...
        if (scrollAmount >= carousel.scrollWidth - carousel.clientWidth + 10) { // Add buffer
      ...
      const resizeObserver = new ResizeObserver(() => {
        cleanup && cleanup(); // Clear old interval
        checkAndScroll();    // Set new one
      });
 ...
 return (
    <>
      <Head>
        ...
        <meta name="description" content="Welcome to mAIple: Innovate, Connect, Inspire. Your gateway to the most groundbreaking AI research and discussions." />
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-950 via-indigo-950 to-purple-950 text-white font-inter flex flex-col overflow-x-hidden">
        ...
        <header className="w-full py-6 px-8 lg:px-20 flex justify-between items-center z-20 relative animate-fade-in-down">
          <div className="text-4xl lg:text-5xl font-extrabold text-white tracking-wider font-montserrat drop-shadow-md">
            mAIple
          </div>
          {/* Navigation Links including Login/Signup */}
          <nav>
            <ul className="flex items-center space-x-6 md:space-x-8 text-lg font-semibold">
              <li><Link href="/#about" className="text-gray-300 hover:text-white transition duration-300 transform hover:scale-105">About</Link></li>
              <li><Link href="/#sponsors" className="text-gray-300 hover:text-white transition duration-300 transform hover:scale-105">Sponsors</Link></li>
              <li><Link href="/#contact-form" className="text-gray-300 hover:text-white transition duration-300 transform hover:scale-105">Contact</Link></li>
              <li className="ml-4">
                <Link href="/login">
                  <div className="text-gray-300 hover:text-white transition duration-200 cursor-pointer text-lg font-medium">Login</div>
                </Link>
              </li>
              <li>
                <Link href="/signup">
        ...
        <section className="relative flex-grow flex flex-col items-center justify-center py-24 px-4 text-center overflow-hidden">
          ...
          <div className="absolute inset-0 z-0 opacity-15">
            <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice" fill="none">
              <circle cx="20" cy="20" r="18" fill="url(#grad1)" className="animate-float-1"></circle>
              <circle cx="85" cy="75" r="28" fill="url(#grad2)" className="animate-float-2"></circle>
              <circle cx="45" cy="95" r="12" fill="url(#grad3)" className="animate-float-3"></circle>
              <rect x="10" y="50" width="15" height="15" rx="3" fill="url(#grad4)" className="animate-float-4"></rect>
              <rect x="70" y="10" width="20" height="20" rx="5" fill="url(#grad5)" className="animate-float-5"></rect>
              <defs>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 py-16 animate-fade-in-up">
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-extrabold text-white mb-8 leading-tight tracking-tight drop-shadow-2xl font-montserrat">
              Unlock the Future of <span className="text-purple-400">Artificial Intelligence</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 mb-12 leading-relaxed max-w-3xl mx-auto drop-shadow-lg">
              Join leading experts, innovators, and researchers at the annual mAIple Conference. Discover breakthroughs, network, and shape tomorrow's AI landscape.
            </p>
        ...
        <section id="about" className="py-20 px-8 lg:px-20 bg-gray-900 bg-opacity-70 backdrop-filter backdrop-blur-lg border-t border-b border-gray-800">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-5xl font-bold text-white mb-12 animate-fade-in drop-shadow-lg font-montserrat">About the Conference</h2>
            <p className="text-lg text-gray-300 leading-relaxed mb-12 animate-fade-in delay-100 max-w-4xl mx-auto">
              The annual mAIple Conference is the premier gathering for anyone passionate about artificial intelligence. Dive deep into cutting-edge machine learning algorithms, ethical AI development, robotics, natural language processing, and much more.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-12">
              <div className="bg-gray-800 bg-opacity-60 p-10 rounded-2xl shadow-xl hover:shadow-2xl transition duration-300 transform hover:-translate-y-3 animate-fade-in delay-200 border border-gray-700">
                <h3 className="text-3xl font-semibold text-purple-400 mb-4">Insightful Keynotes</h3>
                <p className="text-gray-300 text-lg">Hear from AI pioneers and visionaries who are shaping the future of technology, delivering thought-provoking sessions.</p>
              </div>
              <div className="bg-gray-800 bg-opacity-60 p-10 rounded-2xl shadow-xl hover:shadow-2xl transition duration-300 transform hover:-translate-y-3 animate-fade-in delay-300 border border-gray-700">
                <h3 className="text-3xl font-semibold text-blue-400 mb-4">Interactive Workshops</h3>
                <p className="text-gray-300 text-lg">Gain practical skills in hands-on sessions and collaborative workshops led by industry experts and researchers.</p>
              </div>
              <div className="bg-gray-800 bg-opacity-60 p-10 rounded-2xl shadow-xl hover:shadow-2xl transition duration-300 transform hover:-translate-y-3 animate-fade-in delay-400 border border-gray-700">
                <h3 className="text-3xl font-semibold text-green-400 mb-4">Networking Opportunities</h3>
                <p className="text-gray-300 text-lg">Connect with peers, mentors, and potential collaborators from around the globe in a dynamic environment.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Footer */}
        <footer id="contact" className="py-12 px-8 lg:px-20 bg-gray-900 border-t border-b border-gray-800 text-center text-gray-400">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
            <p className="mb-4 md:mb-0">&copy; {new Date().getFullYear()} mAIple Conference. All rights reserved.</p>
            <div className="flex space-x-6">
              <a href="mailto:info@maiple.com" className="text-purple-400 hover:text-white transition duration-300">info@maiple.com</a>
              <a href="#" className="text-purple-400 hover:text-white transition duration-300">Privacy Policy</a>
              <a href="#" className="text-purple-400 hover:text-white transition duration-300">Terms of Service</a>
            </div>
          </div>
        </footer>
      </div>
